...
class UsersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->notEmpty('name','Você deve preencher o nome')
            ->lengthBetween('name',[2,160],'O nome deve ter entre 2 e 160 caracteres');
        ...
        $validator
            ...
            ->notEmpty('password')
            ->lengthBetween('password',[6,30],'A senha deve ter entre 6 e 30 caracteres');
